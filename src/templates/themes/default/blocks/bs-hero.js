blockManager.add('bs-hero-centered', {
    ...
    media: `
    `,
    content: `<div  data-gjs-type="bs-hero"  class="px-4 py-5 my-5 text-center">
...
blockManager.add('bs-hero-dark', {
    ...
    media: `
    `,
    content: `<div data-gjs-type="bs-hero" class="bg-dark text-secondary px-4 py-5 text-center">
                                                <div class="py-5">
...
blockManager.add('bs-hero-left', {
    ...
    media: `
    `,
    content: `<div data-gjs-type="bs-hero" className="container col-xxl-8 px-4 py-5">
    <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
        <div className="col-10 col-sm-8 col-lg-6">
            <img src="bootstrap-themes.png" className="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700"
...
blockManager.add('bs-hero-shadow', {
    ...
    media: `
    `,
    content: `<div data-gjs-type="bs-hero" className="container my-5">
