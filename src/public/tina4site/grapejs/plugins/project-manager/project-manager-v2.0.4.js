/*! grapesjs-project-manager - 2.0.4 */ ! function(e, t) {
    'object' == typeof exports && 'object' == typeof module ? module.exports = t() : 'function' == typeof define && define.amd ? define([], t) : 'object' == typeof exports ? exports["grapesjs-project-manager"] = t() : e["grapesjs-project-manager"] = t()
}(window, (function() {
    return function(e) {
        var t = {};
        ...
        ! function(t) {
            ...
            var n = function() {
                    return {
                        ...
                        mimeType: function(e) {
                            ...
                            return (r = 'application/font-woff', a = 'image/jpeg', {
                                woff: r,
                                woff2: r,
                        ...
                        canvasToBlob: function(e) {
                            return e.toBlob ? new Promise((function(t) {
                                ...
                                return new Promise((function(t) {
                                    for (var n = window.atob(e.toDataURL().split(',')[1]), r = n.length, a = new Uint8Array(r), o = 0; o < r; o++) a[o] = n.charCodeAt(o);
                                    t(new Blob([a], {
                                        type: 'image/png'
                                    }))
                                }))
                        ...
                        resolveUrl: function(e, t) {
                            ...
                            return n.body.appendChild(a), r.href = t, a.href = e, a.href
                        },
                        getAndEncode: function(e) {
                            ...
                            return new Promise((function(n) {
                                ...
                                if (a.onreadystatechange = function() {
                                    ...
                                    if (200 !== a.status) return void(r ? n(r) : i('cannot fetch resource: ' + e + ', status: ' + a.status));
                                    ...
                                    r ? n(r) : i('timeout of ' + t + 'ms occured while fetching resource: ' + e)
                                }, a.responseType = 'blob', a.timeout = t, a.open('GET', e, !0), a.send(), s.impl.options.imagePlaceholder) {
                ...
                r = function() {
                    ...
                    function a(e, t, r, a) {
                        ...
                        })).then(a || n.getAndEncode).then((function(e) {
                ...
                o = function() {
                    return {
                        inlineAll: function t(a) {
                            return a instanceof Element ? function(e) {
                                ...
                                return a instanceof HTMLImageElement ? e(a).inline() : Promise.all(n.asArray(a.childNodes).map((function(e) {
                                    return t(e)
                                })))
                            })) : Promise.resolve(a)
                        },
            ...
            function c(e, t) {
                return function(e) {
                    void 0 === e.imagePlaceholder ? s.impl.options.imagePlaceholder = i.imagePlaceholder : s.impl.options.imagePlaceholder = e.imagePlaceholder;
                    void 0 === e.cacheBust ? s.impl.options.cacheBust = i.cacheBust : s.impl.options.cacheBust = e.cacheBust
                }(t = t || {}), Promise.resolve(e).then((function(e) {
                    return function e(t, r, a) {
                        return a || !r || r(t) ? Promise.resolve(t).then((function(e) {
                            return e instanceof HTMLCanvasElement ? n.makeImage(e.toDataURL()) : e.cloneNode(!1)
                        })).then((function(e) {
                            return o(t, e, r)
                        })).then((function(e) {
                            return function(e, t) {
                                return t instanceof Element ? Promise.resolve().then(r).then(a).then(o).then(i).then((function() {
                                    return t
                                })) : t;

                                function r() {
                                    var r, a;
                                    r = window.getComputedStyle(e), a = t.style, r.cssText ? a.cssText = r.cssText : function(e, t) {
                        ...
                        function o(t, r, a) {
                            var o = t.childNodes;
                            return 0 === o.length ? Promise.resolve(r) : i(r, n.asArray(o), a).then((function() {
                                return r
                            }));
                ...
                return c(e, t).then(n.makeImage).then(n.delay(100)).then((function(r) {
                    var a = function(e) {
                        ...
                        if (r.width = t.width || n.width(e), r.height = t.height || n.height(e), t.bgcolor) {
                            ...
                            a.fillStyle = t.bgcolor, a.fillRect(0, 0, r.width, r.height)
                        }
                        return r
                    }(e);
        ...
        var r = function(e) {
            ...
            return v.prototype = j.constructor = y, y.constructor = v, v.displayName = c(y, s, "GeneratorFunction"), e.isGeneratorFunction = function(e) {
                var t = "function" == typeof e && e.constructor;
                return !!t && (t === v || "GeneratorFunction" === (t.displayName || t.name))
            }, e.mark = function(e) {
                return Object.setPrototypeOf ? Object.setPrototypeOf(e, y) : (e.__proto__ = y, c(e, s, "GeneratorFunction")), e.prototype = Object.create(j), e
            }, e.awrap = function(e) {
                return {
                    __await: e
                }
                ...
                return this
            }, e.AsyncIterator = O, e.async = function(t, n, r, a, o) {
                void 0 === o && (o = Promise);
                var i = new O(u(t, n, r, a), o);
                return e.isGeneratorFunction(n) ? i : i.next().then((function(e) {
                    return e.done ? e.value : i.next()
                }))
            }, P(j), c(j, s, "Generator"), j[o] = function() {
                return this
            }, j.toString = function() {
        ...
        function P(e, t) {
            var n, r = {
                ...
                o = ' ago',
                i = function(e, n) {
                    return void 0 === t ? "".concat(n, " ").concat(e + (n > 1 ? 's' : '') + o) : n + e.substring(0, 1)
                },
                s = Date.now() - new Date(e).getTime();
            for (var c in s < 0 && (s *= (j()("ts"), -1), j()("dir"), o = ' from now'), r) {
        ...
        var k = function() {
            function e(t) {
                ...
                l()(this, e), this.editor = t, this.$ = t.$, this.pfx = t.getConfig('stylePrefix'), this.opts = n, this.setState = this.setState.bind(this), this.setStateSilent = this.setStateSilent.bind(this), this.onRender = this.onRender.bind(this), this.handleTabs = this.handleTabs.bind(this)
            }
            return p()(e, [{
                key: "setState",
                value: function(e) {
        ...
        var L = function(e) {
                ...
                function u(e) {
                    ...
                    return l()(this, u), (t = s.call(this, e, n)).handleSort = t.handleSort.bind(h()(t)), t.handleFilterInput = t.handleFilterInput.bind(h()(t)), t.handleNameInput = t.handleNameInput.bind(h()(t)), t.handleOpen = t.handleOpen.bind(h()(t)), t.handleCreate = t.handleCreate.bind(h()(t)), t.handleDelete = t.handleDelete.bind(h()(t)), t.openEdit = t.openEdit.bind(h()(t)), t.state = {
                        editableProjectId: '',
                        projectId: '',
                        tab: 'pages',
                        sites: [],
                ...
                return p()(u, [{
                    ...
                    key: "onRender",
                    value: (o = a()(c.a.mark((function e() {
                        var t, n, r;
                        return c.a.wrap((function(e) {
                            for (; 1;) switch (e.prev = e.next) {
                                case 0:
                                    return t = this.setState, n = this.cs, t({
                                        loading: !0
                                    }), e.next = 4, n.loadAll();
                                case 4:
                                    r = e.sent, t({
                    ...
                    value: function(e) {
                        ...
                        e.target && e.target.dataset && this.setState({
                    ...
                    value: function(e) {
                        var t = e.target,
                            ...
                            r = this.pfx,
                            a = this.$;
                        n.find(".".concat(r, "tablinks")).removeClass('active'), a(t).addClass('active'), 'pages' === t.id ? this.setState({
                            tab: 'pages'
                        }) : this.setState({
                            tab: 'templates'
                        })
                    ...
                    key: "handleOpen",
                    value: (r = a()(c.a.mark((function e(t) {
                        var n, r, a, o;
                        return c.a.wrap((function(e) {
                            for (; 1;) switch (e.prev = e.next) {
                                case 0:
                                    if (n = this.editor, r = this.cs, (a = this.state.projectId) && a !== r.currentId) {
                                        e.next = 5;
                                        break
                                    }
                                    return this.opts.currentPageOpen(), e.abrupt("return");
                                case 5:
                                    return r.setId(a), e.next = 8, n.load();
                                case 8:
                                    o = e.sent, r.setName(o.name), r.setThumbnail(o.thumbnail || ''), r.setIsTemplate(o.template), r.setDescription(o.description || 'No description'), n.Modal.close();
                                case 14:
                                case "end":
                                    return e.stop()
                            }
                    ...
                    key: "handleCreate",
                    value: (n = a()(c.a.mark((function e(t) {
                        var n, r, a, o, s, u, l, d, p, f, h;
                        return c.a.wrap((function(e) {
                            for (; 1;) switch (e.prev = e.next) {
                                case 0:
                                    if (r = this.editor, a = this.cs, o = this.state, s = o.projectId, u = o.nameText, l = r.runCommand('get-uuidv4'), d = u || 'New-' + l.substring(0, 8), n = {
                                        id: l,
                                        name: d,
                                        template: !1,
                                        thumbnail: '',
                                        ...
                                        pages: "[{\"id\": \"".concat(crypto.randomUUID().substring(0, 13), "\", \"name\": \"index\"}]")
                                    }, i()(n, "styles", '[]'), i()(n, "assets", '[]'), p = n, s) {
                                        e.next = 20;
                                        break
                                    }
                                    return a.setId(l), e.next = 9, a.store(p);
                                case 9:
                                    return a.setIsTemplate(!1), e.next = 12, r.load();
                                case 12:
                                    f = e.sent, a.setId(f.id), a.setName(f.name), a.setThumbnail(f.thumbnail || ''), a.setDescription(f.description || 'No description'), r.Modal.close(), e.next = 30;
                                    break;
                                case 20:
                                    return a.setId(s), a.setIsTemplate(!1), e.next = 24, r.load();
                                case 24:
                                    h = e.sent, a.setId(l), a.setName(d), a.setThumbnail(h.thumbnail || ''), a.setDescription(h.description || 'No description'), r.Modal.close();
                                case 30:
                                case "end":
                                    return e.stop()
                            }
                    ...
                    value: function(e) {
                        ...
                        }), t.Modal.close(), t.SettingsApp.setTab('project'), t.runCommand('open-settings')
                    }
                }, {
                    key: "handleEdit",
                    value: function(e) {
                        this.opts.onUpdateAsync(this.cs.update(D(D({}, e), {}, {
                            updated_at: Date.now()
                        })))
                    }
                }, {
                    key: "handleDelete",
                    value: (t = a()(c.a.mark((function e(t) {
                        var n, r, a, o, i;
                        return c.a.wrap((function(e) {
                            for (; 1;) switch (e.prev = e.next) {
                                case 0:
                                    return n = this.cs, r = this.setState, a = this.opts, e.next = 3, a.onDeleteAsync(n.delete(t.currentTarget.dataset.id));
                                case 3:
                                    return o = e.sent, a.onDelete(o), e.next = 7, n.loadAll();
                                case 7:
                                    i = e.sent, r({
                                        sites: i
                                    });
                    ...
                    value: function() {
                        ...
                        }(i, s) : 'updated_at' === i || 'created_at' === i ? e = function(e, t) {
                            return function(n, r) {
                                var a = new Date(n[e]).getTime(),
                                    o = new Date(r[e]).getTime();
                                return 'asc' === t ? a - o : o - a
                            }
                        }(i, s) : 'pages' === i ? e = function(e, t) {
                            return function(n, r) {
                                ...
                                return a.length > o.length ? -1 : a.length < o.length ? 1 : 0
                            }
                        }(i, s) : 'size' === i && (e = function(e) {
                            return function(t, n) {
                                var r = I(t),
                                    a = I(n);
                                if ('asc' === e) {
                        ...
                        var p = n.sort(e).filter((function(e) {
                            if (!a && 'pages' === r) return !0;
                            var t = e.id,
                                n = e.name,
                                o = e.template;
                            return !(!E(a, t) && !E(a, n) || 'pages' !== r) || !('templates' !== r || !o)
                        })).map((function(e, t) {
                            var n = e.id,
                                r = e.name,
                                a = e.description,
                                ...
                                s = e.updated_at,
                                p = I(e),
                                f = e.pages ? e.pages : u.legacyPrefix ? e["".concat(u.legacyPrefix, "pages")] : [],
                        ...
                        if (!p.length) {
                            if ('templates' === r) return u.nosites || '<div>No Templates Available.</div>';
        ...
        var R = function(e) {
            ...
            function n(e) {
                ...
                return l()(this, n), (r = t.call(this, e, a)).addPage = r.addPage.bind(h()(r)), r.selectPage = r.selectPage.bind(h()(r)), r.removePage = r.removePage.bind(h()(r)), r.isSelected = r.isSelected.bind(h()(r)), r.handleNameInput = r.handleNameInput.bind(h()(r)), r.openEdit = r.openEdit.bind(h()(r)), r.state = {
                    editablePageId: '',
                    isShowing: !0,
                    nameText: '',
                    pages: [],
            ...
            return p()(n, [{
                ...
                value: function(e) {
                    ...
                    }), t.Modal.close(), t.SettingsApp.setTab('page'), t.runCommand('open-settings')
                }
            }, {
                key: "editPage",
                value: function(e, t) {
                ...
                value: function() {
                    var e = this.state,
                        ...
                        r = this.opts,
                        a = this.isSelected;
                    return n ? r.loader || '<div>Loading pages...</div>' : t.map((function(e, t) {
                ...
                value: function() {
                    var e, t, n, r;
                    null === (e = this.$el) || void 0 === e || e.find('.pages').html(this.renderPagesList()), null === (t = this.$el) || void 0 === t || t.find('.page').on('click', this.selectPage), null === (n = this.$el) || void 0 === n || n.find('.page-edit').on('click', this.openEdit), null === (r = this.$el) || void 0 === r || r.find('.page-close').on('click', this.removePage)
                }
            }, {
                key: "render",
                value: function() {
                    var e, t = this.$,
                        n = this.editor;
                    this.onRender(), null === (e = this.$el) || void 0 === e || e.remove();
                    var r = t("<div style=\"display: ".concat(this.state.isShowing ? 'flex' : 'none', ";\" class=\"pages-wrp\">\n                <div class=\"pages\">\n                    ").concat(this.renderPagesList(), "\n                </div>\n                <div  class=\"flex-row\">\n                    <input \n                        class=\"tm-input sm\" \n                        type=\"text\" \n                        placeholder=\"").concat(n.I18n.t('grapesjs-project-manager.pages.placeholder'), "\" \n                    />\n                </div>\n                <div class=\"add-page\">\n                    ").concat(n.I18n.t('grapesjs-project-manager.pages.new'), "\n                </div>\n            </div>"));
                    return r.find('.add-page').on('click', this.addPage), r.find('input').on('change', this.handleNameInput), this.$el = r, r
                }
            }, {
                key: "findPanel",
                get: function() {
                ...
                value: function() {
                    var e;
                    this.state.isShowing = !0, null === (e = this.findPanel) || void 0 === e || e.set('appendContent', this.render()).trigger('change:appendContent'), this.update()
                }
            }, {
                key: "hidePanel",
                value: function() {
        ...
        var B = function(e) {
                ...
                function n(e) {
                    var r, a = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                    return l()(this, n), (r = t.call(this, e, a)).handleSave = r.handleSave.bind(h()(r)), r.handleThumbnail = r.handleThumbnail.bind(h()(r)), r.handleThumbnailInput = r.handleThumbnailInput.bind(h()(r)), r.state = {
                        tab: 'page',
                        loading: !1
                    }, r
                }
                return p()(n, [{
                    ...
                    value: function() {
                        var e = this.$el;
                        null == e || e.find('#settings').html(this.renderSettings()), null == e || e.find('#generate').on('click', this.handleThumbnail), null == e || e.find('input#thumbnail').on('change', this.handleThumbnailInput)
                    }
                }, {
                    key: "onRender",
                    value: function() {
                    ...
                    value: function(e) {
                        ...
                        if ('page' === this.state.tab) {
                            var r = n.PagesApp.editableId,
                                a = null == t ? void 0 : t.find('input.name').val().trim();
                            r && n.PagesApp.editPage(r, a)
                        } else {
                            var o = n.TemplateManager.editableId,
                                i = null == t ? void 0 : t.find('input.thumbnail').val().trim(),
                                s = null == t ? void 0 : t.find('input.name').val().trim(),
                                c = null == t ? void 0 : t.find('input.desc').val().trim(),
                                u = null == t ? void 0 : t.find('input.template').get(0).checked;
                            o && n.TemplateManager.handleEdit({
                                id: o,
                                thumbnail: i,
                                name: s,
                                description: c,
                    ...
                    value: function(e) {
                        ...
                        t.runCommand('take-screenshot', {
                            clb: function(e) {
                                null == n || n.find('img').attr('src', e), this.opts.onThumbnail(e, null == n ? void 0 : n.find('input.thumbnail'))
                            }
                        })
                    }
                }, {
                    ...
                    value: function(e) {
                        var t;
                        null === (t = this.$el) || void 0 === t || t.find('img').attr('src', e.target.value.trim())
                    }
                }, {
                    key: "renderSettings",
                    value: function() {
                        ...
                        if ('page' === t) {
                            var s = o.get(i.PagesApp.editableId),
                                c = (null == s ? void 0 : s.get('name')) || (null == s ? void 0 : s.id) || '';
                    ...
                    value: function() {
                        var e, t = this.$,
                            n = this.editor;
                        this.onRender(), null === (e = this.$el) || void 0 === e || e.remove();
                        var r = t("<div class=\"app\">\n                <div id=\"settings\">\n                    ".concat(this.renderSettings(), "\n                </div>\n                <div class=\"flex-row\">\n                    <button id=\"save\" class=\"primary-button\">\n                        ").concat(n.I18n.t('grapesjs-project-manager.settings.save'), "\n                    </button>\n                </div>\n            </div>"));
                        return r.find('#save').on('click', this.handleSave), r.find('#generate').on('click', this.handleThumbnail), r.find('input#thumbnail').on('change', this.handleThumbnailInput), this.$el = r, r
                    }
                }]), n
            }(k),
            U = L,
        ...
        var q = function(e) {
                ...
                e.domtoimage = F.a, n.add('open-templates', {
                    run: function(e, n) {
                        var r = document.querySelector(".".concat(i, "mdl-dialog"));
                        r.classList.add(s), (null == n ? void 0 : n.set) && n.set('active'), o.setTitle(t.mdlTitle), o.setContent(e.TemplateManager.render()), o.open(), o.getModel().once('change:open', (function() {
                    ...
                    run: function(e, n) {
                        var r = document.querySelector(".".concat(i, "mdl-dialog"));
                        r.classList.add(u), (null == n ? void 0 : n.set) && n.set('active'), o.setTitle(t.mdlTitle), o.setContent(e.SettingsApp.render()), o.open(), o.getModel().once('change:open', (function() {
                ...
                var l = function() {
                    ...
                    d = function() {
                        var e = a()(c.a.mark((function e(n) {
                            var r, a, o, i, s = arguments;
                            return c.a.wrap((function(e) {
                                for (; 1;) switch (e.prev = e.next) {
                                    case 0:
                                        return r = s.length > 1 && void 0 !== s[1] ? s[1] : {}, a = s.length > 2 ? s[2] : void 0, o = s.length > 3 ? s[3] : void 0, e.prev = 3, e.next = 6, t.onScreenshotAsync(F.a.toJpeg(n, r));
                                    case 6:
        ...
        var ee = function(e) {
                ...
                u = function() {
                    return new Promise((function(e, r) {
                        if (t) e(t);
                            ...
                            a.onerror = r, a.onsuccess = function() {
            ...
            r.add(o, Z(Z({}, Y), {}, {
                        ...
                        return c.a.wrap((function(e) {
                            for (; 1;) switch (e.prev = e.next) {
                                case 0:
                                    return e.next = 2, d();
                                case 2:
                                    return n = e.sent, e.abrupt("return", new Promise((function(e, r) {
                        ...
                        return c.a.wrap((function(e) {
                            for (; 1;) switch (e.prev = e.next) {
                                case 0:
                                    return e.next = 2, d();
                                case 2:
                                    return t = e.sent, e.abrupt("return", new Promise((function(e, n) {
                                        var r = t.getAll();
                                        r.onerror = n, r.onsuccess = function() {
                                            e(r.result || [])
                                        }
                                    })));
                                case 4:
                ...
                store: function(e) {
                    ...
                    return a()(c.a.mark((function n() {
                        ...
                        return c.a.wrap((function(n) {
                            for (; 1;) switch (n.prev = n.next) {
                                case 0:
                                    return n.next = 2, d();
                                case 2:
                                    return r = n.sent, n.abrupt("return", new Promise((function(n, a) {
                                        var o = r.put(Z({
                                            id: t.currentId,
                                            name: t.currentName,
                                        ...
                                        o.onerror = a, o.onsuccess = function() {
                                            n(o.result)
                                        }
                                    })));
                                case 4:
                ...
                update: function(e) {
                    return a()(c.a.mark((function t() {
                        var n, r, a;
                        return c.a.wrap((function(t) {
                            for (; 1;) switch (t.prev = t.next) {
                                case 0:
                                    return n = e.id, r = W()(e, ["id"]), t.next = 3, d();
                                case 3:
                                    return a = t.sent, t.abrupt("return", new Promise((function(e, t) {
                                        var o = a.get(n);
                                        o.onerror = t, o.onsuccess = function() {
                                            a.put(Z(Z({
                                                id: n
                                            }, o.result), r)), e(o.result)
                                        }
                                    })));
                                case 5:
                                case "end":
                ...
                load: function() {
                    ...
                    return a()(c.a.mark((function n() {
                        ...
                        return c.a.wrap((function(n) {
                            for (; 1;) switch (n.prev = n.next) {
                                case 0:
                                    return r = e.length > 0 && void 0 !== e[0] ? e[0] : {}, a = i.urlLoad, s = a.endsWith('/') ? t.currentId : "/".concat(t.currentId), n.next = 5, o.load(ne(ne(ne({}, i), {
                                        urlLoad: a + s
                                    }), r));
                                case 5:
                ...
                loadAll: function() {
                    ...
                    return a()(c.a.mark((function t() {
                        ...
                        return c.a.wrap((function(t) {
                            for (; 1;) switch (t.prev = t.next) {
                                case 0:
                                    return n = e.length > 0 && void 0 !== e[0] ? e[0] : {}, t.next = 3, o.load(ne(ne({}, i), n));
                                case 3:
                    ...
                    return a()(c.a.mark((function a() {
                        ...
                        return c.a.wrap((function(a) {
                            for (; 1;) switch (a.prev = a.next) {
                                case 0:
                                    return s = n.length > 1 && void 0 !== n[1] ? n[1] : {}, u = i.urlStore, l = u.endsWith('/') ? r.currentId : "/".concat(r.currentId), a.next = 5, o.store(ne({
                                        id: r.currentId,
                                        name: r.currentName,
                ...
                update: function(e) {
                    return a()(c.a.mark((function t() {
                        ...
                        return c.a.wrap((function(t) {
                            for (; 1;) switch (t.prev = t.next) {
                                case 0:
                                    return n = i.urlStore, r = e.id, r = n.endsWith('/') ? r : "/".concat(r), t.next = 5, o.store(e, ne(ne(ne({}, i), {
                                        urlStore: n + r
                                    }), keys));
                                case 5:
                ...
                delete: function(e) {
                    ...
                    return a()(c.a.mark((function n() {
                        ...
                        return c.a.wrap((function(n) {
                            for (; 1;) switch (n.prev = n.next) {
                                case 0:
                                    return r = o.get('urlDelete'), a = e || t.currentId, a = r.endsWith('/') ? a : "/".concat(a), n.next = 5, o.request(r + a, {
                                        method: 'delete'
                                    });
                                case 5:
        ...
        var ie = function(e) {
                var t, n, r, o = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                    ...
                    g = function() {
                        return r || (firebase.apps.length ? (firebase.app(), (t = firebase.firestore()).settings(p)) : (firebase.initializeApp(oe({
                            apiKey: u,
                            authDomain: l,
                            projectId: d
                        }, o.firebaseConfig)), (t = firebase.firestore()).settings(p)), o.enableOffline && t.enablePersistence().catch(f), r = t.collection(o.objectStoreName))
                    },
                    m = function() {
                        var t = g(),
                            r = e.Storage.getCurrentStorage();
                        ...
                        return a()(c.a.mark((function e() {
                            ...
                            return c.a.wrap((function(e) {
                                for (; 1;) switch (e.prev = e.next) {
                                    ...
                                    case 3:
                                        return n = e.sent, e.abrupt("return", n.exists ? n.data() : {});
                                    case 5:
                                    case "end":
                                        return e.stop()
                                }
                        ...
                        return a()(c.a.mark((function e() {
                            ...
                            return c.a.wrap((function(e) {
                                for (; 1;) switch (e.prev = e.next) {
                                    ...
                                    case 3:
                                        return n = e.sent, r = [], n.forEach((function(e) {
                    ...
                    store: function(e) {
                        ...
                        return a()(c.a.mark((function n() {
                            ...
                            return c.a.wrap((function(n) {
                                for (; 1;) switch (n.prev = n.next) {
                                    case 0:
                                        return r = g(), n.next = 3, r.doc(e.id || t.currentId).set(oe({
                                            id: t.currentId,
                                            name: t.currentName,
                                            template: t.isTemplate,
                                            thumbnail: t.currentThumbnail,
                    ...
                    update: function(e) {
                        return a()(c.a.mark((function t() {
                            ...
                            return c.a.wrap((function(t) {
                                for (; 1;) switch (t.prev = t.next) {
                                    case 0:
                                        return n = e.id, r = W()(e, ["id"]), a = g(), t.next = 4, a.doc(n).set(r, {
                                            merge: !0
                                        });
                                    case 4:
                                    case "end":
        ...
        t["default"] = function(e) {
            ...
            e.I18n.addMessages(le({
                en: ce
            }, n.i18n)), e.TemplateManager = new U(e, n), e.PagesApp = new R(e, n), e.SettingsApp = new B(e, n), q(e, n), se(e, n), e.on('load', a()(c.a.mark((function t() {
                var r, a, o, i;
                return c.a.wrap((function(t) {
                    for (; 1;) switch (t.prev = t.next) {
                        case 0:
                            if (r = e.Storage.getCurrentStorage(), (a = n.customLoad) && 'function' == typeof a && a(e, r), a) {
                                t.next = 9;
                                break
                            }
                            return t.next = 6, r.loadAll();
                        case 6:
                            o = t.sent, (i = o[0]) && n.loadFirst ? (r.setId(i.id), r.setName(i.name), r.setThumbnail(i.thumbnail), r.setIsTemplate(i.template), e.load()) : (r.setId(e.runCommand('get-uuidv4')), r.setName("Default-".concat(r.currentId.substr(0, 7))));
                        case 9:
                        case "end":
                            return t.stop()
                    }
